 ...
 */
public class Calendar_ContentProvider_canonicalize extends CalendarBaseDemonstrator {

    private static final String TAG = Calendar_ContentProvider_canonicalize.class.getSimpleName();

    public Calendar_ContentProvider_canonicalize(String methodName, DemonstratorCallback demonstratorCallback) {
...
//        logCalendarData(context());
        ...
        if(updateUri == null) {
            ...
            context().getContentResolver().canonicalize(updateUri);
            successful = true;
        }
